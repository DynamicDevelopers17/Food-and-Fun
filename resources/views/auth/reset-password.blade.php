                  ...
                  <div class="col-md-10">
                     <div class="d-flex justify-content-center mb-0">
                        <div class="card-body text-center">
                           ...
                           <p class=" text-center">Change Your Password Now</p>
                           ...
                           <div class="row text-start">
                              <div class="col-lg-12">
                                 <div class="floating-label form-group">
                                    ...
                                    <x-jet-input id="email" class="form-control" type="email" aria-describedby="email"  name="email" :value="old('email', $request->email)" required autofocus />
                                 </div>
                              </div>
                              <div class="col-lg-6">
                                 <div class="floating-label form-group">
                              ...
                              <div class="floating-label form-group">
                               ...
                               <div class="d-flex justify-content-center">
                                 <x-jet-button type="submit" class="btn btn-primary">{{ __('Reset Password') }}</x-jet-button>
                              </div>
