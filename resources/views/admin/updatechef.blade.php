            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="{{url('/updatefoodchef',$data->id)}}" method="post" enctype="multipart/form-data">@csrf
                    
                    <div class="form-group">
                        <label> Change Food Name</label>
                        <input type="text" class="form-control" name="name" value="{{$data->name}}" placeholder="Food Name" required>
                      </div>
                      <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="exampleInputCity1">Chef Speciality</label>
                        <input type="text" class="form-control" name="speciality" value="{{$data->speciality}}" placeholder="Food info" required>
                      </div>
