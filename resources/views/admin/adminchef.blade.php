        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Upload Chef Details</h4>
                    <form class="forms-sample" action="{{url('/uploadchef')}}" method="post" enctype="multipart/form-data"> @csrf
                      <div class="form-group">
                        <label>Chef Name</label>
                        <input type="text" class="form-control" name="name" placeholder="Enter Chef Name" required>
                      </div>
                      <div class="form-group">
                        <label>Speciality</label>
                        <input type="text" class="form-control" name="speciality" placeholder="Enter Chef Speciality" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputImage1">Upload chef Image</label>
                        <input type="file"  class="form-control" name="image" required>
                      </div>
                      
                      <div class="form-group">
                        <label for="exampleInputCity1">Food Description</label>
                        <input type="text" class="form-control" name="description" placeholder="Food info" required>
                      </div>
                        ...
                        @foreach($data as $data)
                          <tbody>
                               <tr>
                                  ...
                                  <td> <a button class="btn btn-warning btn-rounded btn-fw" href="{{url('/updatechef',$data->id)}}">Update chef Details</a></td>
                                  <td> <a button class="btn btn-danger btn-rounded btn-fw" href="{{url('/deletechef',$data->id)}}">Delete chef Details </a></td>
                               </tr>
                          </tbody>
                          @endforeach
                       </table>
