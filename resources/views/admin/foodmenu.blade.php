        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Upload Food details</h4>
                    <form class="forms-sample" action="{{url('/uploadfood')}}" method="post" enctype="multipart/form-data"> @csrf
                      ...
                      <div class="form-group">
                        ...
                        <input type="num" class="form-control" name="price"  placeholder="Food Price" required>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputImage1">Upload Food Image</label>
                      ...
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td> <a class="badge badge-warning" href="{{url('/updateview',$data->id)}}">Update Food Item</a></td>
                            <td> <a class="badge badge-danger" href="{{url('/deletemenu',$data->id)}}">Delete Food </a></td>
                          </tr>
                        </tbody>
                        @endforeach
                      </table>
